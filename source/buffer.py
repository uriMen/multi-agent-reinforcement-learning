...
class MultiAgentReplayBuffer:
    def __init__(self, max_size, critic_dims, actor_dims,
        ...
        self.reward_memory = np.zeros((self.mem_size, n_agents), dtype=float)
    ...
    def store_transition(self, raw_obs, state, action, reward,
        ...
        for agent_idx in range(self.n_agents):
            ...
            act_ = np.zeros(self.n_actions)
            act_[action[agent_idx]] = 1
            self.actor_action_memory[agent_idx][index] = act_  # action[agent_idx]
